package tr.org.liderahenk.system.restriction.commands;
...
public class SystemRestrictionCommand implements ICommand {

	private Logger logger = LoggerFactory.getLogger(SystemRestrictionCommand.class);
